...
final class VerifyCsrf implements MiddlewareInterface
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (!Csrf::verify(is_string($token) ? $token : null)) {
            ...
            // 403 وليس 419: الرمز 419 غير مسجَّل لدى IANA، وأباتشي يستبدله
            // بـ 500 عند الإرسال فيظهر انتهاء صلاحية عادي كعُطل في الخادم.
            // لا يظهر ذلك على خادم PHP المدمج لأنه يمرّر الرمز كما هو.
